...
namespace CodePulse.API.Controllers
{
    ...
    public class CategoriesController : ControllerBase
    {
        ...
        // GET: https://localhost:/api/categories/{id}
        [HttpGet]
        [Route("{id:Guid}")]
        ...
        // PUT: https://localhost:/api/categories/{id}
        [HttpPut]
        [Route("{id:Guid}")]
        [Authorize(Roles = "Writer")]
        public async Task<IActionResult> EditCategory([FromRoute] Guid id, Update_CategoryRequestDto request)
        {
        ...
        // DELETE: https://localhost:/api/categories/{id}
        [HttpDelete]
        [Route("{id:Guid}")]
        [Authorize(Roles = "Writer")]
